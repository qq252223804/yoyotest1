...
class RedirectHandler(BaseRedirectHandler):
    ...
    """
    # There's a bug in the case version for some 3.2.x
...
class Locator(object):
    """
    A case class for locators - things that locate distributions.
    """
...
""", re.I | re.S | re.X)
    _base = re.compile(r"""<case\s+href\s*=\s*['"]?([^'">]+)""", re.I | re.S)
