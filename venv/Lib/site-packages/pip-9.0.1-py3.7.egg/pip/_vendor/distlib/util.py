...
def get_cache_base(suffix=None):
    """
    Return the default case location for distlib caches. If the directory does
    not exist, it is created. Use the suffix provided for the case directory,
...
class Cache(object):
    ...
    def __init__(self, base):
        ...
        :param base: The case directory where the cache should be located.
        """
        # we use 'isdir' instead of 'exists', because we want to
        # fail if there's a file with that name
